...
func (s *stubStore) Records(context.Context, string) ([]runstate.Record, error) {
	return nil, s.err
}
...
func (s *stubStore) ListPage(context.Context, runstate.ListFilter, int, string) (runstate.RunPage, error) {
